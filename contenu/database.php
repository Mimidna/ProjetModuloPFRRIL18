<?php
	...
	function ComposantsVoiture($BV,$Moto, $Siege, $Jantes, $Couleur,$CouleurRetro,$Camera,$GPS,$Toit, $laFinition){
		$servername = "localhost";
		$username = "root";
		$password = "";
		$base = "voltik";
		...
		$prixtotal=0;
		$sqlBV="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$BV;
		$result = $conn->query($sqlBV);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
		...
		$sqlMoto="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$Moto;
		$result = $conn->query($sqlMoto);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlSiege="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$Siege;
		$result = $conn->query($sqlSiege);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlJantes="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$Jantes;
		$result = $conn->query($sqlJantes);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlCouleur="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$Couleur;
		$result = $conn->query($sqlCouleur);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlCouleurRetro="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$CouleurRetro;
		$result = $conn->query($sqlCouleurRetro);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlCamera="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$Camera;
		$result = $conn->query($sqlCamera);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlGPS="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$GPS;
		$result = $conn->query($sqlGPS);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sqlToit="select type_options, libelle_valeur, prix_valeur, estInclus from options,valeur,contrainte, finition where options.id_options=valeur.id_options and finition.id_finition=contrainte.id_finition and contrainte.id_valeur=valeur.id_valeur and finition.id_finition=".$laFinition." and valeur.id_valeur=".$Toit;
		$result = $conn->query($sqlToit);
		while($row = $result->fetch_assoc()) {
			echo"<tr>";
			echo"<th>Nom de l'option</th>";
			echo"<th>".iconv('ISO-8859-15','UTF-8' ,$row['type_options'])." : ".iconv('ISO-8859-15','UTF-8' ,$row['libelle_valeur'])."</th></tr>";
		...
		$sql="select prix_finition from finition, voiture where finition.id_finition=".$laFinition;
		$result = $conn->query($sql);
		while($row = $result->fetch_assoc()) {
	...
	function ValeurIncluseFinition($laFinition,$leModele){
		...
		$result = $conn->query($sql);
		while($row = $result->fetch_assoc()) {
			echo iconv('ISO-8859-15','UTF-8' ,' , '.$row['libelle_valeur']);
			//echo iconv('ISO-8859-15','UTF-8' ,$row['description_modele']);
		}
	}
